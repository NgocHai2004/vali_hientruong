...
export const NAV_BASE = [
  ...
  { key: "scene_traces", labelKey: "nav.scene_traces", icon: <Folder /> },
  { key: "detainees", labelKey: "nav.detainees", icon: <FileText /> },
  { key: "detainee_history", labelKey: "nav.detainee_history", icon: <History /> },
